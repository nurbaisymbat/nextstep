...
const DashboardMainAdmin = ({
  usersProgramming,
  usersDesign,
  maxPointsDesign,
  maxPointsProgramming,
  progressDesign,
  progressProgramming
  }) => (
  ...
  <h3><em>Главная</em></h3>
    <div className="row">
      <div className="col-md-6">
        ...
        <h4>Заполняемость контента <small>(Дизайн)</small></h4>
        ...
        {usersDesign.slice(0, 5).map((user, u) =>
            <div key={u}>
              <div>
                <div className="row">
                ...
                <div className="progress myProgressBar">
                  <div className="progress-bar progress-bar-success" role="progressbar" aria-valuenow="70"
                        aria-valuemin="0" aria-valuemax="100" style={{"width": (user.points*100/maxPointsDesign)+'%'}}>
                  </div>
                </div>
                </div>
              </div>
      ...
      <div className="col-md-6">
        ...
        <h4>Заполняемость контента <small>(Программирование)</small></h4>
        <div className="text-right"><span className="btn btn-success"></span><span style={{padding: '10px'}}>Фильм</span>
        <span className="btn btn-warning"></span><span style={{padding: '10px'}}>Книга</span>
        <span className="btn btn-danger"></span><span style={{padding: '10px'}}>Инсайт</span></div>
          {progressProgramming.map((pr, p) =>
            <div key={p}>
            <h5>{pr.name}</h5>
              <div className="progress">
                <div className="progress-bar progress-bar-success" role="progressbar" style={{width: pr.movies + '%'}}>
        ...
        {usersProgramming.slice(0, 5).map((user, u) =>
            <div key={u}>
              <div>
                <div className="row">
                  <div className="col-md-1"><h4 style={{marginTop: '16px'}}>{u+1}</h4></div>
                ...
                <div className="progress myProgressBar">
                  <div className="progress-bar progress-bar-success" role="progressbar" aria-valuenow="70"
                        aria-valuemin="0" aria-valuemax="100" style={{"width": (user.points*100/maxPointsProgramming)+'%'}}>
                  </div>
                </div>
                </div>
              </div>
